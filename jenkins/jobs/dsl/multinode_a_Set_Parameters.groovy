// Kickoff Job for Multi Node provisioning
...
freeStyleJob("${PROJECT_NAME}/Environment_Provisioning_Multi_Node/Set_Environment_Parameters") {
  logRotator(-1, 10)
  parameters {
...
//download ec2-create, oracle-db-12c and oracle-fmw-12
  multiscm {
    git {
      remote {
